...
-- Other roles (parents, teachers, anon) have NO access to read this table.
-- RLS default blocks all access unless a policy grants it, so no extra policy is needed.
