  ...
  return (
    <div className="sidebar-profile-centered">
      ...
      <div className="profile-info-centered">
        ...
        {arabicName && (
          <h3 className="profile-arabic-premium arabic-kanz" style={{ fontFamily: "'Al-Kanz', 'Kanz al Marjaan', serif" }}>
...
function JadeedPagesCard({ count, heading = "Jadeed Safahat" }) {
  return (
    <div className="jadeed-pages-card card-appear">
      ...
      <h4 className="attendance-rating-text arabic-kanz" dir="rtl" style={{ fontSize: '1.6rem', fontFamily: "'Al-Kanz', 'Kanz al Marjaan', serif", marginTop: '8px', color: 'var(--deep-brown)', letterSpacing: 'normal' }}>
        {heading}
      </h4>
      <p className="attendance-sub-label" style={{ textAlign: 'center', fontSize: '11px' }}>
...
function TahfeezReportCard({ student, weeklyResult, settings, parentViewed, timerSeconds, isParentPortal = false }) {
  const arabicStyle = { fontFamily: "'Al-Kanz', 'Kanz al Marjaan', serif" };
            ...
            <div className="card-header">
              ...
              <div className="header-text">
                ...
                {studentProfile?.arabic_name && (
                  <div className="arabic-kanz" style={{ fontSize: '1.4rem', color: 'var(--primary-gold)', fontFamily: "'Al-Kanz', 'Kanz al Marjaan', serif", marginTop: '4px' }}>
