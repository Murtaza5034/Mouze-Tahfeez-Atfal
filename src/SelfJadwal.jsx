...
// Exact ayah → page lookup now comes from quranPageMap (real 604-page Madani mushaf layout).
// getAyahPage is imported above and re-exported for App.jsx compatibility.
