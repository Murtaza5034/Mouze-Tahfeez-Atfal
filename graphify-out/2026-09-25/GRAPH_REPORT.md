# Graph Report - Mauze Tahfeez  (2026-09-25)

## Corpus Check
- 1636 files · ~2,252,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14846 nodes · 25586 edges · 1035 communities (763 shown, 272 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 732 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d4d0bdd`
...
- @capacitor/core
- ./src/core/hooks/
- plugin-loader-sandbox-routing.spec.ts
...
## Communities (1035 total, 272 thin omitted)
...
Cohesion: 0.04
Nodes (6): BaileysAdapter, Channel, ChannelMessage, Label, MessageReaction, ProductQueryOptions

### Community 6 - "plugins.service.ts"
Cohesion: 0.09
Nodes (14): PluginI18n, PluginStatus, annotateCatalog(), CatalogEntry, CatalogPlugin, compareSemver(), PluginDto, ApiPropertyOptional (+6 more)
...
Cohesion: 0.09
Nodes (20): isMissingTableError(), isUniqueViolation(), driverErr(), qfe(), PluginMappingsCapability, PluginsModule, Global, Module (+12 more)
...
### Community 13 - "infra.controller.spec.ts"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (16): EventsGateway, Session, Column, CreateDateColumn, Entity, PrimaryGeneratedColumn, UpdateDateColumn, isAuthTimeoutRejection() (+8 more)

### Community 15 - "app.module.ts"
Cohesion: 0.06
Nodes (48): mcpModules, queueModules, searchModules, serveStaticModules, StorageModule, Global, Module, AgentToolsModule (+40 more)
...
Cohesion: 0.17
Nodes (20): BAILEYS_BROWSER, BAILEYS_LOG_LEVELS, createBaileysLogger(), createSilentLogger(), BaileysBodyContent, BaileysIncomingFields, buildIncomingMessageFromBaileys(), extractBaileysBody() (+12 more)
...
Cohesion: 0.07
Nodes (25): getRequestActor(), AuditController, ApiOperation, ApiQuery, ApiTags, Controller, Get, isExcluded() (+17 more)
...
Cohesion: 0.04
Nodes (35): CapturingLoader, RealWorkerLoader, PluginWorkerHost, FakeChannel, lastLifecycle(), HostToWorkerMessage, PluginLifecycleMethod, PluginLogLevel (+27 more)
...
### Community 32 - "bulk-message.service.ts"
Cohesion: 0.08
Nodes (21): SsrfBlockedError, DateTransformer, renderTemplate(), BulkMessageContent, BulkMessageService, resolveFinalBatchStatus(), resolveMaxConcurrentBatches(), sanitizeBatchError() (+13 more)
...
### Community 36 - "worker-capability.ts"
Cohesion: 0.08
...
Cohesion: 0.15
Nodes (12): EngineStatus, ChatwootFixtureBody, evaluatePreflight(), PreflightRejection, deriveDeliveryId(), extractConversationId(), IngressDeps, IngressRequest (+4 more)

### Community 39 - ".getEngine"
Cohesion: 0.10
Nodes (12): applySendingGate(), Catalog, PaginatedProducts, Product, StatusPostOptions, StatusResult, CatalogService, Injectable (+4 more)
...
### Community 43 - "ApiKey"
Cohesion: 0.08
Nodes (23): ApiHeader, writeSecretFile(), AuditContext, hashApiKey(), API_KEY_FILE, AuthService, bannerKeyLine(), resolveSeedApiKey() (+15 more)

### Community 44 - "BaileysSessionStore"
Cohesion: 0.07
Nodes (19): isSelfAdmin(), mapBaileysGroup(), mapBaileysGroupInfo(), NormalizeJid, BaileysSessionStore, LastMessage, chatKind, ParsedWaId (+11 more)
...
Cohesion: 0.15
Nodes (11): dateColumnType(), isPostgres(), jsonColumnType(), AddMessagesFts1782400000000, bigintToNumberTransformer, MessageDirection, CountRow, FtsResultRow (+3 more)
...
### Community 49 - "logger.service.ts"
Cohesion: 0.03
Nodes (47): ANSI, createLogger(), LEVEL_COLOR, LEVEL_LABEL, LogContext, LogFormat, LogLevel, redactSecrets() (+39 more)
...
Cohesion: 0.08
Nodes (17): getEffectiveWebVersionInfo(), ContainerInfo, DockerService, MANAGED_DOCKER_PROFILES, OrchestrationResult, Injectable, InfraController, writtenEnv() (+9 more)
...
### Community 59 - "group.controller.ts"
Cohesion: 0.17
...
Cohesion: 0.11
Nodes (29): Expose, CreateWebhookDto, ApiProperty, ApiPropertyOptional, ArrayMinSize, IsArray, IsBoolean, IsIn (+21 more)
...
Cohesion: 0.09
Nodes (12): Status, StatusUpdate, Column, Entity, Index, PrimaryGeneratedColumn, IncomingStatus, extFromMimetype() (+4 more)
...
Cohesion: 0.07
Nodes (10): PluginInstance, PluginRegistryEntry, buildSandboxWorkerEnv(), LEGACY_REMOVED_PLUGIN_IDS, PluginLoaderService, resolvePluginMainPath(), seedConfigDefaults(), Injectable (+2 more)
...
Cohesion: 0.14
Nodes (18): sessionTools(), QRCodeResponseDto, SessionResponseDto, ApiProperty, ApiPropertyOptional, SessionStatus, SessionController, ApiOperation (+10 more)

### Community 82 - "filter-types.ts"
Cohesion: 0.07
Nodes (35): toNeutralJid(), IsHeaderMap(), FILTERS_API_EXAMPLE, WEBHOOK_EVENTS, WEBHOOK_RESERVED_EVENTS, WebhookEventType, canonicalActor(), canonicalInput() (+27 more)

### Community 83 - "ApiResponse"
Cohesion: 0.19
Nodes (18): ApiResponse, MessageController, ApiOperation, ApiParam, ApiQuery, ApiTags, Body, Controller (+10 more)
...
Cohesion: 0.05
Nodes (46): AdminAttendanceTracking(), LazyAppUpdateManager, DEPLOY_STAGES, PLAY_TRACKS, STATUS_CONFIG, AppUpdatePopup(), AdminHelpManagement(), CATEGORIES (+38 more)
...
### Community 107 - "infra.module.ts"
Cohesion: 0.22
Nodes (8): EngineModule, Global, Module, DockerModule, Module, InfraModule, queueModules, Module
...
Cohesion: 0.12
Nodes (13): RegisterPluginSearchProviderDeps, SEARCH_DEFAULT_LIMIT, SEARCH_LIMIT_MAX, SEARCH_OFFSET_MAX, SearchController, ApiTags, Controller, bootstrapSearchProviders() (+5 more)
...
### Community 116 - "search.types.ts"
Cohesion: 0.15
Nodes (10): deps(), mkTransport(), registerPluginSearchProvider(), unregisterPluginSearchProvider(), PluginSearchProvider, PluginSearchTransport, SearchHealth, SearchHit (+2 more)
...
### Community 119 - "getting_started/hooks.py"
Cohesion: 0.12
...
### Community 130 - "TeacherProfileView.jsx"
Cohesion: 0.19
...
### Community 131 - "resources/catalog.ts"
Cohesion: 0.19
...
### Community 140 - "stats.service.ts"
Cohesion: 0.19
...
### Community 152 - "plugin-capability.spec.ts"
Cohesion: 0.11
Nodes (13): PluginManifest, manifest, DEFAULT_PACKAGE_LIMITS, INSTALLABLE_TYPES, PackageLimits, ParsedPackage, parsePluginPackage(), readEntryData() (+5 more)

### Community 153 - "session.service.ts"
Cohesion: 0.07
Nodes (35): ChatState, DeliveryStatus, ReactionEvent, ReactionSender, RevokedMessage, MessageStatus, ackStatusTransitionFrom(), deliveryStatusToAck() (+27 more)
...
### Community 164 - "api-key.entity.ts"
Cohesion: 0.09
Nodes (24): AuthValidateController, ApiTags, Controller, PUBLIC_KEY, REQUIRED_ROLE_KEY, SESSION_SCOPED_KEY, ApiKeyRole, SubscribeChannelDto (+16 more)
...
### Community 183 - "BuiltInFtsProvider"
Cohesion: 0.21
...
Cohesion: 0.05
Nodes (48): getWebhookDeliveryFailuresTotal(), incrementWebhookDeliveryFailures(), isSsrfProtectionEnabled(), redactSsrfError(), ConcurrencyLimiter, HooksModule, Global, Module (+40 more)

### Community 187 - "request-context.ts"
Cohesion: 0.19
...
### Community 242 - "MessageResult"
Cohesion: 0.12
Nodes (9): RFC-6350, buildVCard(), isHttpUrl(), loadRemoteMedia(), ContactCard, LocationInput, MediaInput, MessageResult (+1 more)
...
### Community 286 - "catalog.controller.ts"
Cohesion: 0.30
...
### Community 306 - "attendanceSettingsHelper.js"
Cohesion: 0.34
Nodes (13): AdminTeacherAttendanceSettings(), ALL_DAYS, formatTimeDisplay(), TeacherSelfAttendanceCard(), calculateHaversineDistanceMeters(), checkAttendanceWindow(), DAY_NAMES, DEFAULT_ATTENDANCE_SETTINGS (+5 more)
...
### Community 319 - "group.service.ts"
Cohesion: 0.14
...
### Community 343 - "message.service.ts"
Cohesion: 0.11
Nodes (24): SSRF_BLOCKED_CLIENT_MESSAGE, SendAudioMessageDto, SendMediaMessageDto, SendTextMessageDto, ApiProperty, ApiPropertyOptional, ArrayMaxSize, IsArray (+16 more)
...
### Community 384 - "tool-registry.spec.ts"
Cohesion: 0.13
...
### Community 659 - "swagger.config.ts"
Cohesion: 0.24
...
### Community 663 - "ConversationChatTest"
Cohesion: 0.17
...
### Community 670 - "ConversationReceiveStepsTest"
Cohesion: 0.17
...
### Community 693 - "ConversationClearHistoryTest"
Cohesion: 0.20
...
### Community 705 - "session.controller.ts"
Cohesion: 0.08
Nodes (22): SessionScoped(), DeleteChatDto, ApiProperty, IsNotEmpty, IsString, Matches, MarkChatReadDto, ApiProperty (+14 more)
...
### Community 781 - "./src/modules/session/"
Cohesion: 0.40
Nodes (5): ./src/modules/session/, branches, functions, lines, statements

### Community 784 - "[0.8.12] - 2026-07-08"
Cohesion: 0.67
...
### Community 801 - "labels.ts"
Cohesion: 0.29
Nodes (3): LabelsResource, AddLabelRequest, LabelRecord

### Community 802 - "ingress-signature.ts"
Cohesion: 0.36
...
### Community 812 - "PremiumTodaySchedule.jsx"
Cohesion: 0.29
...
### Community 911 - "metrics.service.ts"
Cohesion: 0.50
Nodes (5): getSessionReconnectAttemptsTotal(), getSessionReconnectLoopAlertsTotal(), incrementSessionReconnectAttempts(), incrementSessionReconnectLoopAlerts(), METRICS_RENDER_TTL_MS

### Community 912 - "[0.2.4] - 2026-06-16"
Cohesion: 0.67
Nodes (3): [0.2.4] - 2026-06-16, Added, Fixed

### Community 913 - "redis-throttler.storage.ts"
Cohesion: 0.25
...
### Community 916 - "plugin-loader-sandbox-routing.spec.ts"
Cohesion: 0.25
Nodes (5): IPlugin, FakeHost, manifest(), seed(), TestableLoader

### Community 917 - "ingress.controller.ts"
Cohesion: 0.31
Nodes (4): IngressController, ApiTags, Controller, IngressService

### Community 995 - "ConversationSendDrainTest"
Cohesion: 0.32
...
### Community 996 - "resolveFeatureFlags"
Cohesion: 0.43
...
### Community 1024 - "AuditModule"
Cohesion: 0.67
Nodes (3): AuditModule, Global, Module

### Community 1026 - "[0.7.5] - 2026-06-26"
Cohesion: 0.67
Nodes (3): [0.7.5] - 2026-06-26, Documentation, Fixed

## Knowledge Gaps
- **4440 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `PackageDescription`, `Foundation`, `PathKit` (+4435 more)
...
- **Why does `ApiResponse` connect `ApiResponse` to `RequireRole`, `SearchQueryDto`, `ingress.processor.ts`, `Template`, `ContactService`, `profile.service.ts`, `AuditService`, `MetricsService`, `api.ts`, `ChannelService`, `ApiKey`, `integration.module.ts`, `CallService`, `StatsController`, `GroupService`, `DockerService`, `UpdateWebhookDto`, `group.service.ts`, `StatusController`, `.logInfo`, `CatalogController`, `.receive`, `LabelService`, `ShutdownService`, `auth.controller.ts`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `str` connect `_make_step` to `BuiltinTools`, `Plugins.tsx`, `antigravity/__init__.py`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `IWhatsAppEngine` connect `IWhatsAppEngine` to `BaileysAdapter`, `WhatsAppWebJsAdapter`, `SessionService`, `baileys.adapter.ts`, `ContactService`, `profile.service.ts`, `session.service.ts`, `whatsapp-web-js.adapter.ts`, `bulk-message.service.ts`, `ChannelService`, `.getEngine`, `logger.service.ts`, `CallService`, `GroupService`, `group.service.ts`, `PluginLoaderService`, `message.service.ts`, `LabelService`, `plugin-loader.service.ts`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **What connects `deploy-codex.sh script`, `deploy.sh script`, `PackageDescription` to the rest of the system?**
  _4440 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `App.jsx` be split into smaller, more focused modules?**
  _Cohesion score 0.024493554327808472 - nodes in this community are weakly interconnected._
