# Graph Report - Mauze Tahfeez  (2026-09-15)

## Corpus Check
- 1630 files · ~2,233,731 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14807 nodes · 25492 edges · 1015 communities (740 shown, 275 thin omitted)
...
## Communities (1015 total, 275 thin omitted)
...
Cohesion: 0.04
Nodes (49): [0.10.2] - 2026-07-20, [0.10.4] - 2026-07-21, [0.10.6] - 2026-07-22, [0.10.7] - 2026-07-23, [0.1.6] - 2026-05-17, [0.2.10] - 2026-06-17, [0.2.6] - 2026-06-16, [0.4.6] - 2026-06-20 (+41 more)
...
Cohesion: 0.04
Nodes (39): RFC-7230, buildConversationSendFacade(), ConversationMediaType, ConversationSendDeps, MEDIA_TYPES, MESSAGE_HOOK_EVENTS, ConversationSendEnvelope, IngressChallengeSpec (+31 more)
...
### Community 187 - "plugin-loader.service.ts"
Cohesion: 0.05
...
### Community 228 - "getting_started/hooks.py"
Cohesion: 0.12
...
### Community 319 - "plugin-storage.service.ts"
Cohesion: 0.29
Nodes (7): isPathWithin(), isSafeSessionName(), isSafeStorageKey(), PluginStorage, atomicWriteFileSync(), decodeStorageFileName(), encodeStorageKey()
...
### Community 815 - "[0.8.12] - 2026-07-08"
Cohesion: 0.67
...
- **Why does `IWhatsAppEngine` connect `IWhatsAppEngine` to `message.service.ts`, `engine.factory.ts`, `BaileysAdapter`, `ChannelService`, `WhatsAppWebJsAdapter`, `LabelService`, `.getEngine`, `baileys.adapter.ts`, `ContactService`, `PluginLoaderService`, `SessionService`, `CallService`, `profile.service.ts`, `GroupService`, `session.service.ts`, `whatsapp-web-js.adapter.ts`, `plugin-loader.service.ts`, `plugin.interfaces.ts`?**
